...
if(h>a.maxBucket){a.maxBucket=h;}}a.images[h].push(e);}e._defer_initial_src=g;e._defer_final_src=i;e._defer_state=(g===i?c.loaded:c.unloaded);
if(e._defer_state===c.loaded){a.imagesLoaded++;}return true;}return false;}.bind(this);this.removeImage=function(d){}.bind(this);
